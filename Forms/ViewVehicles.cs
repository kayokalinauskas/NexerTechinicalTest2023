namespace TesteTecnico2023.Forms
{
    ...
    public partial class ViewVehicles : Form
    {
        ...
        private void ViewVehicles_Load(object sender, EventArgs e)
        {
            ...
            {
                listData.Items.Add(new ListViewItem(new string[] {item.Type(), item.Brand, item.ModelName, item.Wheels.ToString(), item.Autonomy.ToString(), item.WeightSupported.ToString(), item.Fuel.ToString() }));
            }
